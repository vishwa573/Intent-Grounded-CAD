...
def run_batch_test(input_csv, output_csv, test_retries=8):
    ...
    json_log_file = 'detailed_attempt_logs.json'
...
if __name__ == "__main__":
    # Ensure you have your prompts.csv created before running
    if not os.path.exists('prompts.csv'):
        print("prompts.csv not found!")
    else:
        out_file = 'benchmark_results_master.csv'
        run_batch_test('prompts.csv', out_file, test_retries=15)
