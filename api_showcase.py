...
def run_api_showcase(input_csv, output_csv, json_log_file, test_retries=15):
    ...
    print(f"--- Starting Groq API Showcase Execution with max_retries={test_retries} ---")
...
if __name__ == "__main__":
    if not os.path.exists('showcase_run/showcase_prompts.csv'):
        ...
        out_csv = 'showcase_run/api_showcase_results.csv'
        out_json = 'showcase_run/api_showcase_logs.json'
